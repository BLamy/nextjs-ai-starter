// ### Examples
// USER: { "teamName": "49ers" }
// ASSISTANT: { tool: "search", req: { query: "Score to most recent 49ers game" }}
...
// ASSISTANT: { tool: "calculator", req: { equation: "41-23" }}
// SYSTEM: 18
...
export type Tools = { tool: 'search', req: { query: string } } | { tool: 'calculator', req: { equation: string } }