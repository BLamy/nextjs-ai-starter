...
async function createAtomComponentPRComment({ GH_REPO_NAME, GH_ORG_NAME, COMPONENT_NAME, OPENAI_API_KEY, LLM_MODEL, PR_COMMENT }) {
...
createAtomComponentPRComment(envSchema.parse(process.env));